            ...
            <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
                ...
                >
                    <Image
                        ...
                        width={560}
                        height={160}
                        className="object-contain h-[72px] md:h-[96px] w-auto brightness-0 drop-shadow-[0_2px_8px_rgba(255,255,255,0.6)] dark:invert dark:drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]"
                        priority
                        unoptimized
